Website that tracks Covid 19 updates using an API. It also offers a Vaccination Portal from where users can check available vaccination centers in their district to book a slot and get vaccinated.
